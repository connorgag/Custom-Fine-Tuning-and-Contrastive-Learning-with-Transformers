...
def params():
    ...
    parser.add_argument("--method", default="supcon", type=str,
                help="Contrastive learning method", choices=['supcon','simclr'])
    parser.add_argument("--learning-rate_2", default=1e-4, type=float,
                help="Model learning rate starting point.")
    parser.add_argument("--n-epochs_2", default=1, type=int,
                help="Total number of training epochs to perform.")

    # Custom 2
    parser.add_argument("--reinit-layers", default=2, type=int,
                help="Number of Layers to Reinitialize")
